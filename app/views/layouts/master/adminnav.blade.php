      ...
      <ul class="nav navbar-nav navbar-right">
        <li >
          ...
          <ul class="dropdown-menu" style="background-color:#000;" aria-labelledby="dLabel">
            <li style="color:#fff;font-size:18px" class="btn btn-sm">Products</li>
            <li style="color:#fff;font-size:18px" class="btn btn-sm">Contacts</li>
            <li style="color:#fff;font-size:18px" class="btn btn-sm">Venues</li>
            <li style="color:#fff;font-size:18px" class="btn btn-sm">Bands</li><br>
            <li style="color:#fff;font-size:18px" class="btn btn-sm">Shows</li>
          </ul>
        </li>
